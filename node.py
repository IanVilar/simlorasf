...
class Node:
    ...
    def schedule_tx(self, packet_rate, packet_size, simulation_duration, sf, tx_power_dbm):
        # Poisson interval
    ...
    def generateTransmissionPowerdBm(self, lower_trans_power, higher_trans_power):
